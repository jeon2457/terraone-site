...
require 'php/db-connect.php'; // DB 연결 (mysqli 객체: $connect 사용)
...
// 새 회원 등록
$sql = "INSERT INTO tel (id, password, name, tel, addr, remark, sms, sms_2, level)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
$stmt = mysqli_prepare($connect, $sql);
mysqli_stmt_bind_param($stmt, "ssssssssi", $id, $hashed_password, $name, $tel, $addr, $remark, $sms, $sms_2, $level);
