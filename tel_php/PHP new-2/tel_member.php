...
.btn-nav:hover {
    background: linear-gradient(135deg, #aeb2c5ff 0%, #403b44ff 100%);
    color: white;
}
...
@media (max-width: 768px) {
  ...
  /* 🔥 모바일에서 숨길 항목들 (번호, 아이디, SMS, SMS추가, 레벨) */
  /* 체크박스는 '선택수정'을 위해 남겨두었습니다. */
  .number-col,
  .id-col,
  .sms-col,
  .sms-list-col,
  ...
  .name-col { width: 20%; }
  .phone-col { width: 30%; }
  .address-col { width: 30%; max-width: 100px; } /* 주소 말줄임 */
  .remark-col { width: auto; }
}
</style>
</head>
<body>
