...
<div class="container">
    ...
    <div class="info-box">
            ...
            하려면 "해당이미지의 주소를 복사한후에" 아래에있는 "⏪ 이미지 업로드로 가기" 버튼을 클릭하면 
            /images_cloudinary_upload.php페이지(Cloudinary📤 이미지 업로드) 에서 하단에있는 
        ...
        <div class="action-bar">
            ...
            <div class="action-buttons">
                ...
                <button type="button" class="btn-nav">
                    <a href="images_cloudinary_upload.php">⏪ 이미지 업로드로 가기</a>
                </button>
            </div>
        </div>
    ...
    <div class="navigation-box">
        <div class="nav-button-item">
            <button type="button" class="btn-navigation">
                <a href="images_cloudinary_upload.php">⏪ Cloudinary up/down room 으로 가기(전용방)</a>
            </button>
        </div>
        <div class="nav-button-item">
            <button type="button" class="btn-navigation">
